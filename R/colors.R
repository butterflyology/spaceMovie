...
SW_palettes <- list(
  ...
  ANH = c("#0E0C12", "#3A3640", "#6D6974", "#B56432", "#DEA021", "#50B8ED"),
  RGO = c("#CB9451", "#60463C", "#CBD3D8", "#7D857E", "#080403", "#CA0F2E"),
  TESB = c("#140F10",  "#3174D8", "#B0B7CE", "#36333D", "#7D857E", "#6F4C33"),
  ROTJ = c("#0E0C0F", "#373438", "#625F63", "#CA0F2E", "#199B4F", "#40CF6B"),
  TPM = c("#27211A", "#5A689B", "#744753", "#0b9e44", "#D8B38D", "#B68C5F"),
  AOTC = c("#647691", "#A9BB99", "#2A2024", "#93530B", "#FF8E1E", "#3E543F"),
  ROTS = c("#D6C078", "#525252", "#787878", "#A10000", "#D90008", "#0E0C0F"),
  TFA = c("#CCB361", "#985C18", "#A10000", "#D90008", "#51B6ED", "#0b9e44")
)
